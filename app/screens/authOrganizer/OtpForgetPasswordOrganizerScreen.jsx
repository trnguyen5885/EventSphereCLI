...
const OtpForgetPasswordOrganizerScreen = ({ navigation, route }) => {
  ...
  const verifyOTP = async () => {
    ...
    try {
      ...
      if (res.message === 'OTP hợp lệ. Bạn có thể đổi mật khẩu.') {
        setError('');
        navigation.navigate('ResetPasswordOrganizer', { email }); // Truyền email sang màn hình đổi mật khẩu
      } else {
...
export default OtpForgetPasswordOrganizerScreen;